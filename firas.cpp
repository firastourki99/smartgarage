...
void firas::on_pushButton_clicked()
{
...
void firas::on_modifier_clicked()
{
    int CIN =ui->lecin->text().toInt();
...
void firas::on_trier_clicked()
{
    ui->tableView->setModel(Etmp.tri());
}

void firas::on_comboBox_currentIndexChanged(int index)
{
...
void firas::on_search_windowIconTextChanged(const QString &arg1)
{
    QString ch = arg1;
...
void firas::on_pushButton_3_clicked()
{

     ui->tableView_2->setModel(Etmp.afficherjoin());
}

void firas::on_lecin2_textChanged(const QString &arg1)
{
    QString ch = arg1;
...
void firas::on_ajoutcarte_clicked()
{
    QMessageBox msgBox;
...
void firas::on_supprimercarte_clicked()
{ QMessageBox msgBox;
    carte c(ui->cin3->text(),ui->point->text());
...
void firas::on_modifiercarte_clicked()
{
    QMessageBox msgBox;
    carte c(ui->cin3->text(),ui->point->text());
       if (c.update())
...
void firas::on_affichercarte_clicked()
{ QMessageBox msgBox;
    carte c;
        ui->tableView_3->setModel(c.afficher());
...
void firas::on_lecin2_textEdited(const QString &arg1)
{
    QString ch = arg1;
