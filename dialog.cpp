...
QByteArray Dialog::read_from_arduino()
{
   if(arduino->isReadable()){
        data=arduino->readAll(); //récupérer les données reçues
...
{
    write_to_arduino("1"); //envoyer 1 à arduino
}


void Dialog::on_pushButton_2_clicked()
{
    write_to_arduino("0"); //envoyer 1 à arduino
}

int Dialog::close_arduino()
